...
public class HomeController : Controller
{
    ...
    public IActionResult ETicaret(string category)
{
    var products = Repository.Products.Where(p => p.IsActive).ToList();
...
public async Task<IActionResult> Create(Product model, IFormFile imageFile)
{
    ...
    if (imageFile != null)
    {
        ...
        {
            ModelState.AddModelError("", "Dosya boyutu en fazla 2 MB olabilir.");
        }
        else
        {
